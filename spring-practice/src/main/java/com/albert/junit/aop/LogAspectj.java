...
public class LogAspectj {
     ...
     * Controller层切点 注解拦截
     */
    @Pointcut("@annotation(com.albert.junit.aop.AuditLogAspect)")
     ...
     * Service层切点 注解拦截
     */
    @Pointcut("execution(* com.albert.junit.aop.service.*.*(..))")
     ...
     * 单个方法拦截
     */
    @After(value = "execution(* com.albert.junit.aop.service.SystemService.addSystem(..))")
    public void after(){
