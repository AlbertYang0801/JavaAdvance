...
public class Fibonacci509 {
    ...
    public static void main(String[] args) {
        Fibonacci509 fibonacci509 = new Fibonacci509();
        System.out.println("暴力解法:" + fibonacci509.fibForce(5));
        System.out.println("备忘录解法:" + fibonacci509.fibBackup(5));
        System.out.println("DP-table解法:" + fibonacci509.fib(5));
        System.out.println("DP-table优化解法:" + fibonacci509.fibOptimization(5));
    }
