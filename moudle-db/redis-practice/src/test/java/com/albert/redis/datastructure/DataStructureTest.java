...
public class DataStructureTest {
    ...
    public void listTest() {
        ...
        System.out.println("倒序获取公众号最近的5篇文章" + JSONUtil.toJsonStr(articleTop));
    }
    ...
    public void hashTest() {
        ...
        System.out.println("购物车信息为：" + JSONUtil.toJsonStr(shopCartList));
    }
    ...
    public void setOneTest() {
        ...
        System.out.println(attractionName + "预约列表：" + JSONUtil.toJsonStr(userSet));
    ...
    public void setTwoTest() {
        ...
        System.out.println("安慰奖不限次数，抽两个人：" + JSONUtil.toJsonStr(pump));


        //只限抽一次，出队
        List<String> list = setLuckDrawService.pumpSingle(1);
        System.out.println("终极大奖，抽一个人，中奖人为：" + JSONUtil.toJsonStr(list));

        //出队后剩下的人
        Set<String> luckDrawList = setLuckDrawService.getLuckDraw();
        System.out.println("未中终极大奖的人：" + JSONUtil.toJsonStr(luckDrawList));
    }
    ...
    public void setThreeTest() {
        ...
        System.out.println("共同关注的人：" + JSONUtil.toJsonStr(commonConcern));

        Set<String> mayKnow = setPersonService.mayKnow(userA, userB);
        System.out.println("userB可能认识的人：" + JSONUtil.toJsonStr(mayKnow));
    }
    ...
    public void zsetTest() {
        ...
        System.out.println("商品销售排行版：" + JSONUtil.toJsonStr(sellScores));
        ...
        System.out.println("商品销售排行版：" + JSONUtil.toJsonStr(newSellScores));
    }
